...
-I didn’t manage to run the application due to the jar file not being located or access the api documentation due to no main manifest attribute.
...
api-tests : Arranged by end-point and each end-point contains a data file if needed (POST, PUT)
